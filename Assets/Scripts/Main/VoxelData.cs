...
public static class VoxelData
{
    ...
    public static readonly int WorldHeightInChunksSq = WorldHeightInChunks * WorldWidthInChunks;
    public static readonly int ChunkHeightSq = ChunkHeightInVoxels * ChunkHeightInVoxels;
